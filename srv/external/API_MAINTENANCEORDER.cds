/* checksum : fc057c657ee0b58e030ab1dd64bad03d */
@cds.external : true
...
service API_MAINTENANCEORDER {
  ...
  @sap.label : 'Linear Asset Management Data'
  entity LinearAssetManagementData {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Object Type'
    @sap.quickinfo : 'Object Type for Linear Data'
    key LinearDataObjectType : String(2) not null;
    @sap.display.format : 'UpperCase'
    @sap.label : 'Table Key'
    @sap.quickinfo : 'Table Key of Reference Object'
    key LinearDataObjectKey : String(30) not null;
    @sap.label : 'Short Description'
    @sap.quickinfo : 'Short Text for Fixed Values'
    LinearDataObjectTypeText : String(60);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Lin.Ref.Pattern'
    @sap.quickinfo : 'Linear Reference Pattern'
    LinearReferencePattern : String(10);
    @sap.label : 'Start Point'
    LinearDataStartPoint : Decimal(11, 3);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Start Marker'
    @sap.quickinfo : 'Marker for Start Point'
    LinearDataStartMarker : String(18);
    @sap.unit : 'LinearDataUnitOfMeasure'
    @sap.label : 'Start Marker Distance'
    LinearDataStartMarkerDistance : Decimal(11, 3);
    @sap.label : 'End Point'
    LinearDataEndPoint : Decimal(11, 3);
    @sap.display.format : 'UpperCase'
    @sap.label : 'End Marker'
    @sap.quickinfo : 'Marker for End Point'
    LinearDataEndMarker : String(18);
    @sap.unit : 'LinearDataUnitOfMeasure'
    @sap.label : 'End Marker Distance'
    LinearDataEndMarkerDistance : Decimal(11, 3);
    @sap.label : 'Marker Distance Unit'
    @sap.quickinfo : 'Unit for the Distance from Marker'
    @sap.semantics : 'unit-of-measure'
    LinearDataMarkerDistanceUnit : String(3);
    @sap.unit : 'LinearDataUnitOfMeasure'
    @sap.label : 'Length'
    LinearDataLength : Decimal(31, 14);
    @sap.label : 'Unit of Measure'
    @sap.quickinfo : 'Unit of Measurement for Linear Data'
    @sap.semantics : 'unit-of-measure'
    LinearDataUnitOfMeasure : String(3);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Type of First Offset'
    LinearDataFirstOffsetType : String(2);
    @sap.unit : 'LinearDataUnitOfMeasure'
    @sap.label : 'First Offset Distance'
    LinearDataFirstOffsetDistance : Decimal(11, 3);
    @sap.label : 'UoM for Offset 1'
    @sap.quickinfo : 'Unit of Measurement for Offset 1'
    @sap.semantics : 'unit-of-measure'
    LinearDataFirstOffsetUnit : String(3);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Type Offset 2'
    @sap.quickinfo : 'Type of Second Offset'
    LinearDataSecondOffsetType : String(2);
    @sap.unit : 'LinearDataUnitOfMeasure'
    @sap.label : 'Second Offset Distance'
    LinearDataSecondOffsetDistance : Decimal(11, 3);
    @sap.label : 'UoM for Offset 2'
    @sap.quickinfo : 'Unit of Measurement for Offset 2'
    @sap.semantics : 'unit-of-measure'
    LinearDataSecondOffsetUnit : String(3);
  };
  ...
  entity MaintenanceOrder {
    ...
    to_LinearAssetManagementData : Association to LinearAssetManagementData {  };
    ...
    to_MaintenanceOrderPartner : Composition of many MaintenanceOrderPartner {  };
    to_MaintenanceOrderPhaseControl : Composition of many MaintenanceOrderPhaseControl {  };
    to_MaintOrderObjectListItem : Composition of many MaintOrderObjectListItem {  };
    //to_MaintOrderSettlmtDistrRule_2 : Composition of many MaintOrderSettlmtDistrRule {  };
  } actions {
    action ApproveMaintenanceOrder() returns DummyFunctionImportResult;
    ...
    ) returns DummyFunctionImportResult;
    action AssignTaskList(
      ...
      @sap.quickinfo : 'Group Counter'
      TaskListGroupCounter : String(2),
      @sap.label : 'Should operations be deleted?'
      @sap.quickinfo : 'Checkbox'
      MaintOrdOpsHaveToBeDeleted : Boolean
    ) returns DummyFunctionImportResult;
    action RejectMaintenanceOrder() returns DummyFunctionImportResult;
    action ReleaseMaintenanceOrder() returns DummyFunctionImportResult;
    action ResetMaintOrderStatusClosed() returns DummyFunctionImportResult;
    action ResetMaintOrderStsRdyForSchedg() returns DummyFunctionImportResult;
    action ResetMaintOrdOpsStsDispatched() returns DummyFunctionImportResult;
    action ResetMaintOrdStsMainWorkCmplt() returns DummyFunctionImportResult;
    ...
    action ResetStatusFromDoNotExecute() returns DummyFunctionImportResult;
    action ScheduleMaintenanceOrder() returns DummyFunctionImportResult;
    action SetMaintOrderOpsToDispatched() returns DummyFunctionImportResult;
    ...
    action SetMaintOrderStatusToLocked() returns DummyFunctionImportResult;
    action SetMaintOrderStatusToUnlocked() returns DummyFunctionImportResult;
    ...
    action SetMaintOrderToReadyForSchedg() returns DummyFunctionImportResult;
    ...
    action SubmitMaintOrderForApproval() returns DummyFunctionImportResult;
  };
  ...
  entity MaintenanceOrderLongText {
    ...
    @sap.label : 'Long Text'
    @sap.sortable : 'false'
    MaintenanceOrderLongText : String;
  ...
  entity MaintenanceOrderOperation {
    ...
    UserStatusText : String(40);
    to_MaintenanceOrder : Association to MaintenanceOrder {  };
    to_MaintOrderOpComponent_2 : Composition of many MaintOrderOpComponent {  };
    to_MaintOrderOpLongText : Composition of many MaintOrderOpLongText {  };
    to_MaintOrderOpPhaseControl : Composition of many MaintOrderOpPhaseControl {  };
    to_MaintOrderOpProdnRsceTool : Composition of many MaintOrderOpProdnRsceTool {  };
    to_MaintOrderOpRelationship : Composition of many MaintOrderOpRelationship {  };
  } actions {
    action ResetMaintOrderOpStsDispatched() returns DummyFunctionImportResult;
    action SetMaintOrderOpToDispatched() returns DummyFunctionImportResult;
  };
  ...
  entity MaintenanceOrderPartner {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Order'
    @sap.quickinfo : 'Order Number'
    @sap.creatable : 'false'
  ...
  entity MaintenanceOrderPhaseControl {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Order'
    @sap.quickinfo : 'Order Number'
    @sap.creatable : 'false'
    ...
    action ActvtMaintOrderPhaseControl() returns DummyFunctionImportResult;
    action DactvtMaintOrderPhaseControl() returns DummyFunctionImportResult;
  };
  ...
  entity MaintOrderActlPlndCostItmSet {
    @sap.display.format : 'UpperCase'
    ...
    to_MaintenanceOrder : Association to MaintenanceOrder {  };
    to_MaintenanceOrderOpComponent_2 : Association to MaintOrderOpComponent {  };
    to_MaintenanceOrderOperation : Association to MaintenanceOrderOperation {  };
    @sap.filterable : 'false'
    Parameters : Association to MaintOrderActlPlndCostItm {  };
  };
  ...
  entity MaintOrderActlPlndCostItm {
    @sap.display.format : 'UpperCase'
    ...
    @sap.filterable : 'false'
    key P_GLAccountHierarchy : String(42) not null;
    Set : Association to many MaintOrderActlPlndCostItmSet {  };
  };
  ...
  entity MaintOrderObjectListItem {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Order'
    @sap.quickinfo : 'Order Number'
    @sap.creatable : 'false'
  ...
  entity MaintOrderOpCompLongText {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Order'
    @sap.quickinfo : 'Order Number'
    @sap.creatable : 'false'
    ...
    to_MaintenanceOrder : Association to MaintenanceOrder {  };
    to_MaintenanceOrderComponent : Association to MaintOrderOpComponent {  };
  };
  ...
  entity MaintOrderOpComponent {
    ...
    to_MaintenanceOrderOperation : Association to MaintenanceOrderOperation {  };
    to_MaintenanceOrder : Association to MaintenanceOrder {  };
    to_MaintOrderOpCompLongText : Composition of many MaintOrderOpCompLongText {  };
  };
  ...
  entity MaintOrderOpPhaseControl {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Order'
    @sap.quickinfo : 'Order Number'
    @sap.creatable : 'false'
    ...
    action ActvtMaintOrderOpPhaseControl() returns DummyFunctionImportResult;
    action DactvtMaintOrderOpPhaseControl() returns DummyFunctionImportResult;
  };
  ...
  entity MaintOrderOpProdnRsceTool {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Order'
    @sap.quickinfo : 'Order Number'
    @sap.creatable : 'false'
  ...
  entity MaintOrderOpRelationship {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Order'
    @sap.quickinfo : 'Order Number'
    @sap.creatable : 'false'
  ...
  entity MaintOrderSettlmtDistrRule {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Order'
    @sap.quickinfo : 'Order Number'
    @sap.creatable : 'false'
